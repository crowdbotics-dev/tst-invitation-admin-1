...
## Project Structure
    ...
    ├── tst_invitation_admin_1  # Django project configurations
...
1. Clone this repo and `cd tst_invitation_admin_1`
...
2. Clone this repo and `cd tst_invitation_admin_1`
