"""
Django settings for tst_invitation_admin_1 project.
...
ROOT_URLCONF = 'tst_invitation_admin_1.urls'
...
WSGI_APPLICATION = 'tst_invitation_admin_1.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "tst_invitation_admin_1 API",
    "DESCRIPTION": "API documentation for tst_invitation_admin_1 App",
    "VERSION": "v1",
}
